...
public class CalenderActivity extends AppCompatActivity implements GridView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        today.setText(mMonth+"/"+mDay+"/"+mYear);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (l!=0){
            if (l==mDay){
                ...
                Toast.makeText(view.getContext(),"Check-in successed!",Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(view.getContext(),"Date you picked: "+today,Toast.LENGTH_SHORT).show();
